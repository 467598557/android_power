...
public class AccessibilityOperator {
    private static final OperatorHelper operatorHelper = new OperatorHelper();
    ...
    private AccessibilityOperator AccessibilityOperatorHolder;
    ...
    public void start(AccessibilityService service, AccessibilityEvent event) {
        ...
        operatorHelper.start(service, event);
    }
